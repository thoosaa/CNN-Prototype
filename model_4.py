...
x = layers.Conv2D(32, kernel_size=(5, 5), padding="valid", activation=activations.relu)(inputs)
x = layers.MaxPooling2D(pool_size=(3, 3), strides=1)(x)
x = layers.Conv2D(32, kernel_size=(5, 5), padding="valid", activation=activations.swish)(x)
x = layers.MaxPooling2D(pool_size=(3, 3), strides=1)(x)
x = layers.Conv2D(64, kernel_size=(3, 3), padding="valid", activation=activations.relu)(x)
x = layers.MaxPooling2D(pool_size=(3, 3), strides=1)(x)
x = layers.Conv2D(32, kernel_size=(3, 3), padding="valid", activation=activations.leaky_relu)(x)
x = layers.MaxPooling2D(pool_size=(3, 3), strides=1)(x)
x = layers.Flatten()(x)

x = layers.Dense(512, activation=activations.tanh)(x)
x = layers.Dropout(0.8)(x)
x = layers.Dense(512, activation=activations.elu)(x)
