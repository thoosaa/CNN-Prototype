...
x = layers.Conv2D(8, kernel_size=(7, 7), activation="leaky relu", padding="valid")(inputs)
x = layers.MaxPooling2D(pool_size=(2, 2), strides=1)(x)
x = layers.Conv2D(16, kernel_size=(5, 5), activation="leaky relu", padding="valid")(x)
x = layers.MaxPooling2D(pool_size=(2, 2), strides=1)(x)
x = layers.Conv2D(32, kernel_size=(3, 3), activation="softmax", padding="valid")(x)
x = layers.MaxPooling2D(pool_size=(3, 3), strides=1)(x)
x = layers.Conv2D(32, kernel_size=(3, 3), activation="leaky relu", padding="valid")(x)
x = layers.MaxPooling2D(pool_size=(3, 3), strides=1)(x)
x = layers.Conv2D(16, kernel_size=(5, 5), activation="leaky relu", padding="valid")(x)
x = layers.MaxPooling2D(pool_size=(3, 3), strides=1)(x)
x = layers.Flatten()(x)

x = layers.Dense(1024, activation="leaky relu")(x)
x = layers.Dense(1024, activation="leaky relu")(x)
x = layers.Dropout(0.2)(x)
x = layers.Dense(1024, activation="leaky relu")(x)
x = layers.Dropout(0.2)(x)
x = layers.Dense(512, activation="leaky relu")(x)
x = layers.Dropout(0.2)(x)
x = layers.Dense(512, activation="leaky relu")(x)
