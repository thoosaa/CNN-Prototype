...
x = layers.Conv2D(32, kernel_size=(5, 5), padding="same", activation=activations.relu)(inputs)
x = layers.MaxPooling2D(pool_size=(3, 3), strides=2)(x)
x = layers.Conv2D(64, kernel_size=(3, 3), padding="same", activation=activations.tanh)(x)
x = layers.MaxPooling2D(pool_size=(3, 3), strides=2)(x)
